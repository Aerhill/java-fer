...
/**
 * This servlet performs the action of editing existing {@link BlogEntry} 
 * and storing it into the all holy database.
 * 
 * @author Ante Spajic
 *
 */
...
public class EditBlogEntryServlet extends HttpServlet {
	private static final long serialVersionUID = 1896461779121795050L;

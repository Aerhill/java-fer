...
/**
 * This Java Persistence API data access object implementation
 * is used for communication with database.
 * 
 * @author Ante Spajic
 *
 */
...
public class JPADAOImpl implements DAO {
	...
	public List<BlogUser> getBlogUsers() throws DAOException {
		List<BlogUser> lista = (List<BlogUser>)JPAEMProvider.getEntityManager()
				.createQuery("select b from BlogUser b")
				.getResultList();
		JPAEMProvider.close();
		return lista;
	}
	...
	public BlogUser getUser(String nick) {
		...
		BlogUser user = null;
		try {
			user =(BlogUser)em.createQuery("select u from BlogUser u where u.nick=:nick")
	 ...
	 * 
	 * @param obj object to be persisted to database
	 */

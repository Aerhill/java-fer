...
/**
 * This action is used for exporting files in JPEG, PNG, GIF format.
 * 
 * @author Ante Spajic
 *
 */
public class ExportFileAction extends AbstractAction {
	...
	private static final long serialVersionUID = -7349596538419900997L;
	...
	/**
	 * Creates an image with extension <code>ext</code>, fills it with objects

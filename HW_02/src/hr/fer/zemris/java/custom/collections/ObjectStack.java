...
/**
 * Implementation of stack with adaptor pattern using the ArrayIndexedCollection from
 * previous problem as an adaptee.
 * 
 * @author Ante Spajic
 *
 */
public class ObjectStack {
     ...
     * @throws EmptyStackException When attempted to pop an element from an empty stack.
     */
    public Object pop() {

 ...
 * asemblersku operaciju <code>add</code> koja zbraja sadržaj pohranjen u dva
 * registra i sprema ga u prvi navedeni registar. Navedena operacija ne podržava
...
public class InstrAdd implements Instruction {
	 ...
	 * zbrajanja, operacija prima listu argumenata od kojih su dva registra čije
	 * se pohranjene vrijednosti zbrajaju i spremaju u prvi registar argument liste.
	 * 
	 * @param arguments
	 *            lista argumenata koji sadrži redom, registar za pohranu
	 *            rezultata i dva argumenta operacije zbrajanja
	 */

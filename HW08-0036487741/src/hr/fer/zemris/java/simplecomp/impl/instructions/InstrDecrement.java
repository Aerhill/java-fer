 ...
 * asemblersku operaciju <code>decrement</code> koja dekrementira sadržaj pohranjen u dva
...
public class InstrDecrement implements Instruction {
	...
	/**
	 * index registra kojemu želimo smanjiti vrijednost
	 */
	private int indexRegistra;

	/**
	 * Javni konstruktor koji prima listu sa samo jednim argumentom koji index
	 * registra u računalu čiji sadržaj želimo smanjiti za 1.
	 * 
	 * @param arguments
